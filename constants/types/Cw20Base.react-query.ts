...
export function useCw20BaseDownloadLogoQuery<TData = DownloadLogoResponse>({
  ...
  return useQuery<DownloadLogoResponse, Error, TData>(cw20BaseQueryKeys.downloadLogo(client?.contractAddress), () => client ? client.downloadLogo() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCw20BaseMarketingInfoQuery<TData = MarketingInfoResponse>({
  ...
  return useQuery<MarketingInfoResponse, Error, TData>(cw20BaseQueryKeys.marketingInfo(client?.contractAddress), () => client ? client.marketingInfo() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCw20BaseMinterQuery<TData = MinterResponse>({
  ...
  return useQuery<MinterResponse, Error, TData>(cw20BaseQueryKeys.minter(client?.contractAddress), () => client ? client.minter() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCw20BaseTokenInfoQuery<TData = TokenInfoResponse>({
  ...
  return useQuery<TokenInfoResponse, Error, TData>(cw20BaseQueryKeys.tokenInfo(client?.contractAddress), () => client ? client.tokenInfo() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
